      ...
      <Flex direction='col' className='index'>
        <Flex className='head'>
          ...
          <Flex className='content' direction='col'>
            ...
            <Typography.Text className='txt' type='white'>该产品为<Typography.Text className='info'>真品</Typography.Text>，请放心引用，如有疑问请<Typography.Text className='info'>进一步验证</Typography.Text>。</Typography.Text>
          </Flex>
        </Flex>
